...
class TestSafeContractSignature(SafeTestCaseMixin, TestCase):
    def test_contract_signature_for_message(self):
        ...
        safe_owner_signature = account.unsafe_sign_hash(safe_owner_message_hash)["signature"]
    ...
    def test_contract_signature(self):
        ...
        contract_signature = owner_1.unsafe_sign_hash(safe_tx_hash_2_message_hash)["signature"]
    ...
    def test_contract_multiple_signatures(self):
        ...
        contract_signature_2 = owner_1.unsafe_sign_hash(safe_tx_hash_message_hash)["signature"]
